/*The LoggedIn component will be displayed when a user has a valid 
access token, which means they are logged in. */
  ...
  return (
    <div className="container">
      <div className="jumbotron text-center mt-5">
        {isAuthenticated && <span className="btn btn-primary float-right" onClick={() => logout()}>Salir</span>}
        <h1>Bistro</h1>
        <p>
          Hola, {user.name}! En esta ventana podrás editar el menú de tu restaurante
        </p>
        <div className="row">
